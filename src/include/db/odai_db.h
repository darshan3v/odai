...
public:
  ...
  virtual OdaiResult<void> initialize_db() = 0;
  ...
  virtual OdaiResult<void> rollback_transaction() = 0;
  ...
  virtual OdaiResult<ModelFiles> get_model_files(const ModelName& name) = 0;
  ...
  virtual OdaiResult<std::string> get_model_checksums(const ModelName& name) = 0;
  ...
  virtual OdaiResult<InputItem> store_media_item(const InputItem& item) = 0;
  ...
  virtual OdaiResult<void> create_semantic_space(const SemanticSpaceConfig& config) = 0;
  ...
  virtual OdaiResult<SemanticSpaceConfig> get_semantic_space_config(const SemanticSpaceName& name) = 0;
  ...
  virtual OdaiResult<std::vector<SemanticSpaceConfig>> list_semantic_spaces() = 0;
  ...
  virtual OdaiResult<void> delete_semantic_space(const SemanticSpaceName& name) = 0;
  ...
  virtual OdaiResult<bool> chat_id_exists(const ChatId& chat_id) = 0;
  ...
  virtual OdaiResult<void> create_chat(const ChatId& chat_id, const ChatConfig& chat_config) = 0;
  ...
  virtual OdaiResult<ChatConfig> get_chat_config(const ChatId& chat_id) = 0;
  ...
  virtual OdaiResult<std::vector<ChatMessage>> get_chat_history(const ChatId& chat_id) = 0;
  ...
  /// @return empty expected if all messages inserted successfully, or an unexpected OdaiResultEnum indicating the
  /// error.
  virtual OdaiResult<void> insert_chat_messages(const ChatId& chat_id, const std::vector<ChatMessage>& messages) = 0;
