...
typedef struct
{
    JNIEnv *env;             // valid because call is synchronous
    jobject callbackRef;     // global or local ref
    jmethodID onChunkMethod; // cached method ID
...
typedef struct
{
    JNIEnv *env;           // valid because call is synchronous
    jobject callbackRef;   // global or local ref
    jmethodID onLogMethod; // cached method ID
} LogCallbackContext;
...
extern "C"
{
    ...
    Java_com_odai_demo_RagEngine_odaiSetLogger(JNIEnv *env,
                                               jobject thiz,
                                               jobject callbackObj)
    {
    ...
    JNIEXPORT void JNICALL
    Java_com_odai_demo_RagEngine_odaiSetLogLevel(OdaiLogLevel log_level)
    {
        odai_set_log_level(log_level);
    }

    JNIEXPORT jboolean JNICALL
    Java_com_odai_demo_RagEngine_odaiInitializeSDK(
        JNIEnv *env,
        jobject thiz,
        jstring dbPath,
    ...
    JNIEXPORT jboolean JNICALL
    Java_com_odai_demo_RagEngine_odaiInitializeRagEngine(
        JNIEnv *env,
        jobject thiz,
    ...
    JNIEXPORT jboolean JNICALL
    Java_com_odai_demo_RagEngine_odaiAddDocument(
        JNIEnv *env,
        jobject thiz,
        jstring content,
        jstring documentId,
    ...
    Java_com_odai_demo_RagEngine_odaiGenerateResponse(
        JNIEnv *env,
        jobject thiz,
        jstring query,
        jstring scopeId)
    ...
    // -----------------------------------------------------------------------------
    JNIEXPORT jboolean JNICALL
    Java_com_odai_demo_RagEngine_odaiGenerateStreamingResponse(
        JNIEnv *env,
        jobject thiz,
        jstring query,
        jstring scopeId,
