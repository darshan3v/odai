...
Uses [stb_image](https://github.com/nothings/stb) (single-file header library) to decode image files into raw pixel buffers. Supports PNG, JPG, JPEG, BMP, TGA, GIF, HDR, PNM, PPM, PGM, and PSD formats.
...
- Header-only integration details live in [`dev_nuances.md`](../../../dev_nuances.md#best-practice-dedicated-implementation-file-header-only)
